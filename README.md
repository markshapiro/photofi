Mobile App to browse live photos of events (Parties, Weddings etc.) and upload from personal camera device using wireless LAN card that fetches photos from device to mobile app.
